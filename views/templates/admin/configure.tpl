...
<ul class="nav nav-tabs" role="tablist">
	<li class="active"><a href="#template_1" role="tab" data-toggle="tab">{l s='Payshop' mod='eupago_payshop'}</a></li>
	<li><a href="#template_2" role="tab" data-toggle="tab">{l s='About euPago' mod='eupago_payshop'}</a></li>
</ul>
