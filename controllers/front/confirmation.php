...
class Eupago_payshopConfirmationModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        /**
         * the payment will be made after in time, so the status will be always waiting for payment
         */
        $payment_status = Configuration::get('EUPAGO_A_AGUARDAR_PAGAMENTO_PAYSHOP'); // Default value for a payment that succeed.
